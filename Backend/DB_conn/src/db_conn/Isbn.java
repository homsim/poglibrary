...
public class Isbn {
    ...
    public Isbn(String isbn) throws FaultyIsbnException {
    ...
    public Isbn(String isbn, boolean format) throws FaultyIsbnException {
    ...
    private void setIsbnType(String isbn) throws FaultyIsbnException {
        String raw = isbn.replaceAll("-", "");
        switch (raw.length()) {
            case 10:
    ...
    private void checkIsbn(String isbn) throws FaultyIsbnException {
    ...
    private static void checksumThirteen(ArrayList<Integer> digits) throws FaultyIsbnException {
        int chksum = 0;
