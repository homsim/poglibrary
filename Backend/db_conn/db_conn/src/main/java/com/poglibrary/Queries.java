...
public final class Queries {
    ...
    protected static final String DB_BASE_URL = "jdbc:mariadb://localhost";
    protected static final String DB_PORT = "3306"; // might make sense to make it dynamic (dhcp with mariadb? possible
                                                    // overkill?)
    protected static final String DB_NAME = "testdb"; // change
    protected static String DB_URL = DB_BASE_URL + ":" + DB_PORT + "/" + DB_NAME;
    protected static final String DB_USER = "exampleuser"; // change
    protected static final String DB_PW = "password"; // change and make more save (SHA256?)
